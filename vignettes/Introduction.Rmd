...
Note: the age-10 class is a 'plus group' which includes fish ages 10 and older.

```{r prop_age_plot, fig.width = 8, fig.height = 5}
...
### Display weight-at-age data

Plot annual weight-at-age for each stock and period.

```{r wt_age_plot, fig.width = 8, fig.height = 5}
wt_age_long <- wt_age %>%
  pivot_longer(
      cols = starts_with("a", ignore.case = FALSE), names_to = "Age",
      values_to = "Weight"
...
```{r wt_age_sn_plot, fig.width = 8, fig.height = 5}
